...
local globalKeys =
  ...
  awful.key(
    ...
    {description = 'Opens netflix', group = 'programs'}
  ),
  awful.key(
    {modkey},
    'Print',
  ...
  awful.key(
    ...
    {description = 'select (tiling, floating, expand) next', group = 'layout'}
  ),
  awful.key(
    {modkey, 'Shift'},
    'space',
    ...
    {description = 'select (tiling, floating, expand) previous', group = 'layout'}
  ),
  awful.key(
    {modkey, 'Control'},
    'n',
  ...
  awful.key(
    ...
    'space',
    function()
      awful.util.spawn_with_shell('vm-attach attach')-- TODO
    end
  ),
  ...
  awful.key(
    ...
    {description = 'Opens code', group = 'programs'}
  ),
  -- Spotify 
  awful.key(
    {modkey, 'Shift'},
    ...
    {description = 'Opens spotify', group = 'programs'}
  ),
  -- File Manager
  awful.key(
    {modkey},
